...
$(document).ready(function () {
	...
	$(".maximize-box").hide();
	//menus function
	$("#scientific-mode").click(function () {
		swal({
			title: 'Coming Soon!!',
			animation: false,
			customClass: 'animated rotateInDownRight'
		});
	});
	$("#minimize").click(function () {
		/* close calculator */
		$(".calculator").slideUp(); /* open maximize-box */
		$(".maximize-box").show();
	})
	$(".maximize-box").click(function () {
		/* close maximize box */
		$(".maximize-box").hide(); /* open calculator */
		$(".calculator").slideDown();
	});
	$("#exit").click(function () {
		/* close maximize */
		$(".maximize-box").hide(); /* close calculator */
		$(".calculator").fadeOut();
	});
	...
	$(document).keydown(function (e) {
		if (e.which == 13) {
			...
			if ($("#function-box").val() == "") {
				...
				$("#input-box").val(ans);
				$("#history-box").val($("#first-box").val() + "\t" + $("#function-box").val() + "\t" + $("#second-box").val() + "\t=\t" + ans + '\n\n' + $("#history-box").val());
